 ...
 */
void aurora_pairable_host_set_cancelled(bool cancelled);
 ...
 */
struct IdeviceFfiError *aurora_pairable_host_accept(const char *name,
                                                    const char *model,
                                                    void (*pin_callback)(const char *pin,
                                                                         void *context),
                                                    void *pin_context,
                                                    void (*listening_callback)(uint16_t port,
                                                    ...
                                                    void (*connected_callback)(void *context),
